...
class _ProfilePageState extends State<ProfilePage>
  ...
  double _getPhotoRadius(double screenWidth) {
    if (screenWidth < 600) return 56.0;
    if (screenWidth < 1024) return 64.0;
    return 72.0;
  }
  ...
  Widget _buildProfilePhoto() {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final photoRadius = _getPhotoRadius(screenWidth);
